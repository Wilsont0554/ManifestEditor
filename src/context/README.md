...
Overview needs to know which fields were actually changed without hard-coding default text, language values, or manifest technical defaults inside the tab.
