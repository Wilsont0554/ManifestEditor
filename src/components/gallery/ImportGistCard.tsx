...
import GistHelpModal from "@/components/shared/gist-help-modal";
  ...
  return (
    <>
      <form
        ...
        className="group relative flex h-full flex-col gap-4 overflow-hidden rounded-xl border border-slate-200 bg-slate-50 p-6 transition-all duration-300 hover:border-slate-900 hover:bg-white hover:shadow-[0_24px_60px_-30px_rgba(15,23,42,0.45)] focus-within:border-slate-900 focus-within:bg-white focus-within:shadow-[0_24px_60px_-30px_rgba(15,23,42,0.45)]"
      >
        ...
        <div className="mt-auto flex flex-col gap-2">
          ...
          <button
            ...
            className="w-fit text-xs font-bold text-pink-700 transition hover:text-slate-950"
          >
            Need a Gist or GitHub token?
          </button>
          {errorMsg && (
