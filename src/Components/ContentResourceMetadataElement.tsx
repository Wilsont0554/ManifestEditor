...
type MetadataField = "label" | "value" | "language";

function ContentResourceMetadataElement({
  manifestObj,
  ...
  if (!resource) {
    return <p>No resource found or metadata not supported.</p>;
  }
  ...
  const handleUpdateMetadata = (index: number, field: MetadataField, value: string) => {
            ...
            >
              <div className="field-group" style={{ marginBottom: "8px" }}>
                ...
                <input
                  ...
                  onChange={(event) => handleUpdateMetadata(index, "label", event.target.value)}
                  style={{
                    width: "100%",
                    padding: "6px 8px",
              ...
              <div className="field-group" style={{ marginBottom: "8px" }}>
                ...
                <textarea
                  ...
                  onChange={(event) => handleUpdateMetadata(index, "value", event.target.value)}
                  rows={2}
                  style={{
                    width: "100%",
                    padding: "6px 8px",
              ...
              <div className="field-group" style={{ marginBottom: "8px" }}>
                ...
                <select
                  ...
                  onChange={(event) => handleUpdateMetadata(index, "language", event.target.value)}
                  style={{
                    width: "100%",
                    padding: "6px 8px",
                    border: "1px solid #ccc",
